...
namespace CalciWebApp
{
    public partial class CalciApp : System.Web.UI.Page
    {
        ...
        {
                if (DisplayTextBox1.Text == "0" && DisplayTextBox1.Text != null)
                {
        ...
        protected void ButtonNumberDevide_Click(object sender, EventArgs e)
        {
            ...
            {
                DisplayTextBox1.Text = "0";
                Response.Write("<alert>Enter the operand first</alert>");
            }
            else
            {
                DisplayTextBox1.Text = DisplayTextBox1.Text + "/";
